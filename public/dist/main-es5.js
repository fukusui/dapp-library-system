...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [
                {
                    path: 'home',
                    loadChildren: function () { return Promise.resolve( /*! import() */).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(function (mod) { return mod.HomeModule; }); }
                },
                {
                    path: 'office',
                    loadChildren: function () { return Promise.resolve( /*! import() */).then(__webpack_require__.bind(null, /*! ./office/office.module */ "./src/app/office/office.module.ts")).then(function (mod) { return mod.OfficeModule; }); },
                },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(book) {
                    this.book = book;
                }
                HomeComponent.prototype.getBooks = function (evt) {
                    this.books = evt;
                    delete this.bookData;
                };
                HomeComponent.prototype.selectBook = function (evt) {
                    this.bookData = evt;
                    delete this.books;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchAuthorComponent = /** @class */ (function () {
                function SearchAuthorComponent(formBuilder, book) {
                ...
                SearchAuthorComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.book.searchAuthor(this.authorForm.value)
                        ...
                        if (authors.length > 0) {
                            for (var _i = 0, authors_1 = authors; _i < authors_1.length; _i++) {
                                var data = authors_1[_i];
                                _this.book.check({ author: data._id }).subscribe(function (data) {
                                    if (data.length > 0) {
                                        _this.addBookEvent.emit(data);
                                    }
                                });
                            }
                        }
                ...
                return SearchAuthorComponent;
            }());
            SearchAuthorComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchGenreComponent = /** @class */ (function () {
                function SearchGenreComponent(book) {
                    this.book = book;
                    this.addBookEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                }
                SearchGenreComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.book.genres().subscribe(function (genres) {
                        _this.genres = genres;
                    });
                };
                SearchGenreComponent.prototype.searchGenre = function () {
                    var _this = this;
                    if (this.genre) {
                        this.book.check({ genre: this.genre }).subscribe(function (data) {
                            if (data.length > 0) {
                                _this.addBookEvent.emit(data);
                            }
                        });
            ...
            SearchGenreComponent.ctorParameters = function () { return [
                { type: _shared_book_service__WEBPACK_IMPORTED_MODULE_2__["BookService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LibGuard = /** @class */ (function () {
                function LibGuard(libService, router) {
                    this.libService = libService;
                    this.router = router;
                }
                LibGuard.prototype.canActivateChild = function () {
                    var _this = this;
                    return this.libService.auth$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
                        if (data >= 1) {
                            return true;
                        }
                        else {
                            _this.router.navigateByUrl('office/login');
                            return false;
                        }
                    }));
                };
            ...
            LibGuard.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_librarian_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/librarian.service */ "./src/app/office/services/librarian.service.ts");
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            var LibNonGuard = /** @class */ (function () {
                function LibNonGuard(libService, router) {
                    this.libService = libService;
                    this.router = router;
                }
                LibNonGuard.prototype.canActivate = function () {
                    var _this = this;
                    return this.libService.auth$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
                        if (data >= 1) {
                            _this.router.navigateByUrl('office');
                            return false;
                        }
                        else {
                            return true;
            ...
            LibNonGuard.ctorParameters = function () { return [
                { type: _services_librarian_service__WEBPACK_IMPORTED_MODULE_3__["LibService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var OfficeGuard = /** @class */ (function () {
                function OfficeGuard(office, router) {
                    this.office = office;
                    this.router = router;
                }
                OfficeGuard.prototype.canActivateChild = function () {
            ...
            OfficeGuard.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _services_office_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/office.service */ "./src/app/office/services/office.service.ts");
            var OfficeNonGuard = /** @class */ (function () {
                function OfficeNonGuard(office, router) {
                    this.office = office;
                    this.router = router;
                }
                OfficeNonGuard.prototype.canActivate = function () {
                    if (this.office.isLoggedIn()) {
                ...
                return OfficeNonGuard;
            }());
            OfficeNonGuard.ctorParameters = function () { return [
                { type: _services_office_service__WEBPACK_IMPORTED_MODULE_3__["OfficeService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CheckInOutComponent = /** @class */ (function () {
                function CheckInOutComponent(checkInOut, book) {
                    this.checkInOut = checkInOut;
                    this.book = book;
                }
                CheckInOutComponent.prototype.getUsers = function (users) {
                    this.users = users;
                    delete this.user;
                    delete this.bookData;
                };
                CheckInOutComponent.prototype.getUser = function (user) {
                    this.userData(user);
                    delete this.users;
                };
                CheckInOutComponent.prototype.getBooks = function (books) {
                    this.books = books;
                };
                CheckInOutComponent.prototype.bookEvent = function (book) {
                    this.bookData = book;
                    this.bookData.checkout = true;
                };
                CheckInOutComponent.prototype.selectInstance = function (book) {
                    var _this = this;
                    this.checkInOut.barrow(book, this.user)
                        .subscribe(function (_a) {
                        var book = _a[0], user = _a[1];
                        _this.userData(user);
                        _this.book.getById(book.book)
                            .subscribe(function (data) { return delete _this.bookData; });
                    });
                };
                CheckInOutComponent.prototype.returnBook = function (bookInstance) {
                    var _this = this;
                    this.checkInOut.returnBook(bookInstance, this.user)
                        .subscribe(function (data) { return _this.userData(data); });
                };
                CheckInOutComponent.prototype.userData = function (user) {
                    if (user.due_books.length > 0) {
                        user.books = [];
                        this.checkInOut.getBooks(user)
                            .subscribe(function (data) { user.books.push(data); });
                        this.user = user;
                    }
                    else {
                        this.user = user;
                ...
                return CheckInOutComponent;
            }());
            CheckInOutComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchUsersComponent = /** @class */ (function () {
                function SearchUsersComponent(office, formBuilder) {
                    this.office = office;
                    this.formBuilder = formBuilder;
                ...
                SearchUsersComponent.prototype.onSubmit = function () {
                    var _this = this;
                    var user = ({ name: {
                    ...
                    this.office.searchUser(user).subscribe(function (data) {
                        if (data.length > 0) {
                            _this.usersEvent.emit(data);
                        }
                    });
                    this.userForm.reset();
                };
            ...
            SearchUsersComponent.ctorParameters = function () { return [
                { type: _services_office_service__WEBPACK_IMPORTED_MODULE_3__["OfficeService"] },
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserComponent = /** @class */ (function () {
                ...
                UserComponent.prototype.isRed = function (dueDate) {
                    var date = new Date();
                    if (dueDate > date) {
                        return true;
                    }
                ...
                UserComponent.prototype.returnBook = function (book) {
                    var bookInstance = book.instance;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UsersComponent = /** @class */ (function () {
                function UsersComponent(office) {
                    this.office = office;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateBookComponent = /** @class */ (function () {
                function CreateBookComponent(book, office, formBuilder) {
                    this.book = book;
                    this.office = office;
                    this.formBuilder = formBuilder;
                ...
                CreateBookComponent.prototype.getBooks = function (evt) {
                    this.books = evt;
                    delete this.bookData;
                    delete this.alertMessage;
                };
                CreateBookComponent.prototype.bookEvent = function (e) {
                    this.bookData = e;
                };
                CreateBookComponent.prototype.onSubmit = function () {
                    ...
                    for (var i = 0; i < this.instanceForm.value.quantity; i++) {
                        this.office.saveInstance(bookInstance).subscribe(function (data) {
                            console.log(data);
                        });
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_office_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/office.service */ "./src/app/office/services/office.service.ts");
            var BookDataComponent = /** @class */ (function () {
                function BookDataComponent(bookInfo, office) {
                    this.bookInfo = bookInfo;
                    this.office = office;
                    this.alertEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                }
                BookDataComponent.prototype.ngOnChanges = function () {
                    var bookInfo = this.bookData.volumeInfo;
                ...
                BookDataComponent.prototype.saveBook = function () {
                    var _this = this;
                    this.office.saveBook(this.bookInfo.data)
                        .subscribe(function (data) {
                        _this.alertEvent.emit();
                        delete _this.book;
                    });
                };
                return BookDataComponent;
            }());
            BookDataComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _services_bookData_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../services/bookData.service */ "./src/app/office/services/bookData.service.ts");
            var CheckAuthorComponent = /** @class */ (function () {
                function CheckAuthorComponent(bookInfo) {
                    this.bookInfo = bookInfo;
                }
                CheckAuthorComponent.prototype.replace = function (author) {
                ...
                return CheckAuthorComponent;
            }());
            CheckAuthorComponent.ctorParameters = function () { return [
                { type: _services_bookData_service__WEBPACK_IMPORTED_MODULE_2__["BookDataService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateDataComponent = /** @class */ (function () {
                ...
                CreateDataComponent.prototype.dataEvent = function (e) {
                    this.bookData = e;
                    delete this.alertMessage;
                };
                CreateDataComponent.prototype.alertEvent = function () {
                    this.alertMessage = true;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchDataComponent = /** @class */ (function () {
                function SearchDataComponent(formBuilder, book) {
                    this.formBuilder = formBuilder;
                    this.book = book;
                ...
                SearchDataComponent.prototype.onSubmit = function () {
                    var _this = this;
                    var searchData = this.bookForm.value.title + '+inauthor:' + this.bookForm.value.author;
                    this.book.search(searchData).subscribe(function (data) {
                        _this.books = data.items;
                    });
                    this.bookForm.reset();
                };
                SearchDataComponent.prototype.selectData = function (book) {
                    this.dataEvent.emit(book);
                    delete this.books;
                };
                return SearchDataComponent;
            }());
            SearchDataComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
                { type: _shared_book_service__WEBPACK_IMPORTED_MODULE_3__["BookService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EmployeeComponent = /** @class */ (function () {
                function EmployeeComponent(libService) {
                    this.libService = libService;
                }
                EmployeeComponent.prototype.ngOnInit = function () {
                    this.loadEmployee();
                };
                EmployeeComponent.prototype.registerEmp = function (employee) {
                    var _this = this;
                    this.libService.addEmployee(employee.address)
                        .subscribe(function (data) { return _this.loadEmployee(); });
                };
                EmployeeComponent.prototype.addAdmin = function (employee) {
                    var _this = this;
                    this.libService.addAdmin(employee.address)
                        .subscribe(function (data) { return _this.loadEmployee(); });
                };
                EmployeeComponent.prototype.deleteEmp = function (employee) {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(router, libService) {
                    this.router = router;
                    this.libService = libService;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(router, formBuilder, office) {
                    this.router = router;
                    this.formBuilder = formBuilder;
                    this.office = office;
                ...
                LoginComponent.prototype.onSubmit = function () {
                    this.office.login(this.credentials.value).subscribe(function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var OfficeHomeComponent = /** @class */ (function () {
                function OfficeHomeComponent(office, router, libService) {
                    this.office = office;
                    this.router = router;
                    this.libService = libService;
                    this.links = headerLinks;
                    this.libService.auth$.subscribe(function (data) {
                        console.log(data);
                        // if (data == 0) {
                        //   this.router.navigateByUrl('office/login');
                        // }
                ...
                OfficeHomeComponent.prototype.logout = function () {
                    this.office.logout();
                };
                return OfficeHomeComponent;
            }());
            OfficeHomeComponent.ctorParameters = function () { return [
                { type: _services_office_service__WEBPACK_IMPORTED_MODULE_3__["OfficeService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var ReturnButtonComponent = /** @class */ (function () {
                function ReturnButtonComponent() {
                }
                return ReturnButtonComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BookDataService = /** @class */ (function () {
                ...
                BookDataService.prototype.sort = function (book) {
                ...
                BookDataService.prototype.getISBN = function (isbn) {
                    if (isbn) {
                        this.data.isbn = isbn;
                        this.checkBookExist(isbn);
                    }
                };
                BookDataService.prototype.checkBookExist = function (isbn) {
                    var _this = this;
                    this.book.check({ isbn: isbn })
                        ...
                        if (data.length >= 1) {
                            ...
                            _this.data.saved = false;
                        }
                    });
                };
                BookDataService.prototype.getAuthor = function (authors) {
                    this.data.authors = [];
                ...
                BookDataService.prototype.getGenre = function (genres) {
                    this.data.genres = [];
                    if (genres) {
                ...
                BookDataService.prototype.sortName = function (authors) {
                    for (var _i = 0, authors_2 = authors; _i < authors_2.length; _i++) {
                        ...
                        if (splitName.length === 3) {
                            ...
                            var name = { first_name: author };
                            this.data.authors.push(name);
                        }
                    }
                };
                BookDataService.prototype.searchAuthor = function (authors) {
                    var _this = this;
                    for (var _i = 0, authors_3 = authors; _i < authors_3.length; _i++) {
                        var author = authors_3[_i];
                        this.book.searchAuthor(author).subscribe(function (data) {
                            if (data.length > 0) {
                                _this.data.savedAuthors.push(data[0]);
                            }
                        });
                    }
                };
            ...
            BookDataService.ctorParameters = function () { return [
                { type: _shared_book_service__WEBPACK_IMPORTED_MODULE_2__["BookService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CheckInOutService = /** @class */ (function () {
                function CheckInOutService(book, office) {
                    this.book = book;
                    this.office = office;
                }
                CheckInOutService.prototype.barrow = function (book, user) {
                    ...
                    var updateUser = { id: user._id, instanceId: book._id };
                ...
                CheckInOutService.prototype.dueDate = function () {
                    var today = new Date();
                    var newDate = new Date();
                    newDate.setDate(today.getDate() + 12);
                    return newDate;
                };
                CheckInOutService.prototype.getBooks = function (user) {
                    var _this = this;
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(user.due_books).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (id) { return _this.book.instanceId(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (bookInstance) { return _this.book.getById(bookInstance.book); }, function (original, detail) { return ({ book: detail, instance: original }); })); }));
                };
                CheckInOutService.prototype.returnBook = function (bookInstance, user) {
                    var _this = this;
                    var returnData = { id: bookInstance._id, availability: "available" };
                    var returnUser = { id: user._id, due_books: bookInstance._id };
                    return this.office.instanceReturn(returnData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function () { return _this.office.userReturn(returnUser); }));
                };
                return CheckInOutService;
            }());
            CheckInOutService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LibService = /** @class */ (function () {
                function LibService(web3Service, office) {
                    var _this = this;
                    this.web3Service = web3Service;
                    this.office = office;
                    this.libContract$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(this.web3Service.getWeb3()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((function (provider) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(_this.getLibContract(provider)); })));
                    this.auth$ = this.web3Service.account$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (address) { return _this.employee(address); }));
                }
                LibService.prototype.getLibContract = function (web3) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var networkId, deployedNetwork, instance, e_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    networkId = _a.sent();
                                    deployedNetwork = build_contracts_Librarian_json__WEBPACK_IMPORTED_MODULE_6__.networks[networkId];
                                    instance = new web3.eth.Contract(build_contracts_Librarian_json__WEBPACK_IMPORTED_MODULE_6__.abi, deployedNetwork && deployedNetwork.address);
                ...
                LibService.prototype.employee = function (address) {
                    return this.libContract$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (contract) { return contract.methods.employee(address).call(); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
                };
                LibService.prototype.auth = function () {
                    var _this = this;
                    var account = this.office.getAdminDetails();
                    return this.office.getAdmin(account._id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (admin) { return _this.employee(admin.address); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
                };
                LibService.prototype.addEmployee = function (address) {
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["combineLatest"])(this.web3Service.account$, this.libContract$).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (_a) {
                        var account = _a[0], contract = _a[1];
                        return contract.methods.addEmployee(address)
                            .send({ from: account });
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
                };
                LibService.prototype.addAdmin = function (address) {
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["combineLatest"])(this.web3Service.account$, this.libContract$).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (_a) {
                        var account = _a[0], contract = _a[1];
                        return contract.methods.addAdmin(address)
                            .send({ from: account });
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
                };
                LibService.prototype.deleteEmp = function (address) {
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["combineLatest"])(this.web3Service.account$, this.libContract$).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (_a) {
                        var account = _a[0], contract = _a[1];
                        return contract.methods.deleteEmployee(address)
                            .send({ from: account });
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
                };
                LibService.prototype.combinedData = function () {
                    var _this = this;
                    return this.office.getAdmins().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])((function (admins) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(admins).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (admin) { return _this.employee(admin.address); }, function (original, detail) { return (Object.assign({}, original, { auth: detail })); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["toArray"])()); })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
                };
                LibService.prototype.handleError = function (error) {
                    var errorMessage = '';
                    if (error.error instanceof ErrorEvent) {
                        // client-side error
                        errorMessage = "Error: " + error.error.message;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var OfficeService = /** @class */ (function () {
                function OfficeService(http, router) {
                    this.http = http;
                    this.router = router;
                ...
                OfficeService.prototype.saveToken = function (token) {
                    localStorage.setItem('admin-token', token);
                    this.token = token;
                };
                OfficeService.prototype.getToken = function () {
                    if (!this.token) {
                        this.token = localStorage.getItem('admin-token');
                    }
                    return this.token;
                };
                OfficeService.prototype.getAdminDetails = function () {
                ...
                OfficeService.prototype.isLoggedIn = function () {
                    var admin = this.getAdminDetails();
                    if (admin) {
                ...
                OfficeService.prototype.logout = function () {
                    this.token = '';
                    window.localStorage.removeItem('admin-token');
                    this.router.navigateByUrl('office/login');
                };
                OfficeService.prototype.login = function (admin) {
                    var _this = this;
                    return this.http.post(this.apiUrl + 'office/login', admin).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
                        if (data.token) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Web3Service = /** @class */ (function () {
                function Web3Service() {
                    ...
                    this.getWeb3().then(function (web3) {
                        _this.web3 = web3;
                    });
                    this.account$ = this.interval$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function () { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(_this.web3.eth.getAccounts()); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (accounts) { return accounts && accounts[0] ? accounts[0] : null; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["shareReplay"])(1));
                }
                Web3Service.prototype.getWeb3 = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var web3;
                        return __generator(this, function (_a) {
                            try {
                                ...
                                return [2 /*return*/, new web3__WEBPACK_IMPORTED_MODULE_4___default.a(window.ethereum || window.web3 || this.dappUrl)];
                            }
                            return [2 /*return*/];
                        });
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BookService = /** @class */ (function () {
                ...
                BookService.prototype.searchAuthor = function (author) {
                    return this.http.post(this.apiUrl + "author/search", author);
                };
                BookService.prototype.check = function (query) {
                    return this.http.post(this.apiUrl + "book/search", query);
                };
                BookService.prototype.instance = function (query) {
                    return this.http.post(this.apiUrl + "book_instance/search", query);
                };
                BookService.prototype.instanceId = function (id) {
                ...
                BookService.prototype.genres = function () {
                    return this.http.get(this.apiUrl + "genre/");
                };
                BookService.prototype.genre = function (id) {
            ...
            var BookComponent = /** @class */ (function () {
                ...
                BookComponent.prototype.ngOnChanges = function () {
                    ...
                    if (this.bookData.genre) {
                        ...
                        for (var _i = 0, _a = this.bookData.genre; _i < _a.length; _i++) {
                            var genre = _a[_i];
                            this.book.genre(genre).subscribe(function (data) {
                                _this.bookData.genreName.push(data);
                            });
                        }
                    }
                    this.book.instance({ book: this.bookData._id })
                        .subscribe(function (data) {
                        if (data.length > 0) {
                            _this.bookData.instances = data;
                        }
                    });
                };
                BookComponent.prototype.instanceSelect = function (instance) {
            ...
            var BooksComponent = /** @class */ (function () {
                ...
                BooksComponent.prototype.ngOnChanges = function () {
                    var _loop_1 = function (book) {
                        for (var _i = 0, _a = book.author; _i < _a.length; _i++) {
                            var author = _a[_i];
                            this_1.book.searchAuthor({ _id: author }).subscribe(function (data) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchTitleComponent = /** @class */ (function () {
                function SearchTitleComponent(formBuilder, book) {
                    this.formBuilder = formBuilder;
                    this.book = book;
                    this.addBookEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                ...
                SearchTitleComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.book.check(this.titleForm.value).subscribe(function (data) {
                        if (data.length > 0) {
                            _this.addBookEvent.emit(data);
                        }
                    });
            ...
            SearchTitleComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
